...
return apply_filters('qibla_opt_inc_import_export_fields', array(
    ...
    'qibla_opt_export:submit' => $fieldFactory->table(array(
        ...
        'label' => esc_html_x('Export Plugin Options', 'settings', 'qibla-directory'),
        'value' => esc_html_x('Export', 'settings', 'qibla-directory'),
        'attrs' => array(
            'class' => array(
                'button',
                'button-primary',
    ...
    'qibla_opt_import:file'   => $fieldFactory->table(array(
        ...
        'use_btn'           => true,
        'file_submit_label' => esc_html_x('Import', 'settins', 'qibla-directory'),
        'label'             => esc_html_x('Import Plugin Options', 'settings', 'qibla-directory'),
        'description'       => esc_html_x('Import data retrieved by a previous backup.', 'settings', 'qibla-directory'),
        'value'             => esc_html_x('Import', 'settings', 'qibla-directory'),
    ...
    'qibla_opt_reset:submit'  => $fieldFactory->table(array(
        ...
        'id'          => 'qibla_opt_reset',
        'label'       => esc_html_x('Reset Plugin Options', 'settings', 'qibla-directory'),
        'description' => esc_html_x(
            'This will reset all of the settings to their default values.',
            'settings',
            'qibla-directory'
        ),
        'value'       => esc_html_x('Reset', 'settings', 'qibla-directory'),
        'attrs'       => array(
            'class' => array(
                'button',
                'button-secondary',
