...
return apply_filters('qibla_opt_inc_search_fields', array(
    ...
    'qibla_opt-search-type:select'               => $fieldFactory->table(array(
        ...
        'label'        => esc_html_x('Search Type', 'settings', 'qibla-directory'),
        'description'  => esc_html_x('Select the type of the search.', 'settings', 'qibla-directory'),
        'select2'      => true,
        'exclude_none' => true,
        'value'        => F\getPluginOption('search', 'type', true),
        'options'      => array(
            'geocoded' => esc_html_x('Search and Geocode', 'settings', 'qibla-directory'),
            'simple'   => esc_html_x('Simple Search', 'settings', 'qibla-directory'),
            'combo'    => esc_html_x('Search, Geocode and Categories', 'settings', 'qibla-directory'),
        ),
        'attrs'        => array(
    ...
    'qibla_opt-search-placeholder:text'          => $fieldFactory->table(array(
        ...
        'label'       => esc_html_x('Search Placeholder', 'settings', 'qibla-directory'),
        'description' => esc_html_x('The placeholder for the search input text.', 'settings', 'qibla-directory'),
        'attrs'       => array(
    ...
    'qibla_opt-search-geocoded_placeholder:text' => $fieldFactory->table(array(
        ...
        'label'       => esc_html_x('Geocode Placeholder', 'settings', 'qibla-directory'),
        'description' => esc_html_x('The placeholder for the search geocoded field.', 'settings', 'qibla-directory'),
        'attrs'       => array(
    ...
    'qibla_opt-search-submit_label:text'         => $fieldFactory->table(array(
        ...
        'label'       => esc_html_x('Input Submit Label', 'settings', 'qibla-directory'),
        'description' => esc_html_x('The label for the submit button.', 'settings', 'qibla-directory'),
        'attrs'       => array(
    ...
    'qibla_opt-search-submit_icon:text'          => $fieldFactory->table(array(
        ...
        'label'       => esc_html_x('Input Submit Icon', 'settings', 'qibla-directory'),
        'description' => esc_html_x('The icon for the submit button.', 'settings', 'qibla-directory'),
