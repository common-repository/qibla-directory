...
use QiblaDirectory\PostType;
use QiblaDirectory\Taxonomy;
use QiblaDirectory\Shortcode;
        ...
        'action' => array(
            ...
            array(
                ...
                'callback' => function ($adminBar) {
                    ...
                    $qiblaPage       = new \QiblaDirectory\Admin\Page\Settings();
                    $usefulLinksPage = new \QiblaDirectory\Admin\Page\UsefulLinks();
            ...
            array(
                'filter'   => 'widgets_init',
                'callback' => array(
                    new \QiblaDirectory\Sidebars\Register(
                        include QiblaDirectory\Plugin::getPluginDirPath('/inc/sidebarsList.php')
                    ),
                    'register',
                ),
            ...
            array(
                ...
                'callback' => 'QiblaDirectory\\Functions\\addImageSizes',
                'priority' => 30,
            ),
            array(
                'filter'   => 'after_setup_theme',
            ...
            array(
                ...
                'callback' => function ($postID) {
                    $average = new \QiblaDirectory\Review\AverageCrud(get_post($postID));
            ...
            array(
                ...
                'callback' => 'QiblaDirectory\\Functions\\svgLoaderTmpl',
                'priority' => 40,
            ),
            ...
            array(
                ...
                'callback'      => function ($instance, $args) {
                    if (! empty($args['plugin']) &&
                        in_array('qibla-directory/index.php', (array)$args['plugin'], true) &&
                        'plugin' === $args['type'] &&
                        'update' === $args['action']
                    ) {
                        \QiblaDirectory\Activate::activate();
                    }
                },
                'priority'      => 20,
                'accepted_args' => 2,
