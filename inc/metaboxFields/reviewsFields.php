...
use \QiblaDirectory\Review\RatingCommentMeta;
use \QiblaDirectory\Review\Rating;
...
return apply_filters('qibla_mb_inc_comment_additional_fields', array(
    'qibla_mb_comment_rating:select' => $fieldFactory->base(array(
        ...
        'label'        => esc_html__('Rating', 'qibla-directory'),
        'options'      => Rating::getRatingList(),
        'exclude_none' => true,
        'description'  => esc_html__('Set the number of the rating.', 'qibla-directory'),
    ...
    'qibla_mb_comment_title:text'    => $fieldFactory->base(array(
        ...
        'label'        => esc_html__('Review Title', 'qibla-directory'),
        'exclude_none' => true,
        'description'  => esc_html__('Type the title for the review.', 'qibla-directory'),
        'display'      => array($this, 'displayField'),
        'attrs'        => array(
            'class'    => 'widefat',
