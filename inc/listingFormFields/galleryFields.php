...
$imageNum = intval(\QiblaDirectory\Functions\getPostMeta(
...
return apply_filters('qibla_listings_form_gallery_fields', array(
    ...
    'qibla_listing_form-gallery:file'              => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Upload images for gallery', 'qibla-directory'),
        'accept'              => 'image/jpeg,image/png',
        'use_dropzone'        => true,
        'skip_upload'         => true,
        'restriction'         => 'allow_gallery',
        'invalid_description' => esc_html__('Please enter valid images format.', 'qibla-directory'),
        'dropzone'            => array(
            'dictDefaultMessage' => esc_html__('Gallery images', 'qibla-directory'),
