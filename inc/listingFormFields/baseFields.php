...
return apply_filters('qibla_listings_form_base_fields', array(
    ...
    'qibla_listing_form-post_title:text'             => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Title', 'qibla-directory'),
        'container_class'     => array('dl-field', 'dl-field--text', 'dl-field--in-column'),
        'attrs'               => array(
            'required'    => 'required',
            'placeholder' => esc_html_x('My awesome hotel', 'placeholder', 'qibla-directory'),
            'value'       => $fieldsValues['post_title'],
        ),
        'invalid_description' => esc_html__('Please only valid characters.', 'qibla-directory'),
    ...
    'qibla_listing_form-meta-sub_title:text'         => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Tag line', 'qibla-directory'),
        'container_class'     => array('dl-field', 'dl-field--text', 'dl-field--in-column'),
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('Best place in the whole world.', 'placeholder', 'qibla-directory'),
            // For tests only.
    ...
    'qibla_listing_form-thumbnail:file'              => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Upload the Main image', 'qibla-directory'),
        'container_class'     => array('dl-field', 'dl-field--file', 'dl-field--clear-in-column'),
        'use_dropzone'        => true,
        'accept'              => 'image/jpeg,image/png',
        'invalid_description' => esc_html__('Please enter a valid image format.', 'qibla-directory'),
        'dropzone'            => array(
            'thumbnailWidth'     => 1080,
            'thumbnailHeight'    => 607,
            'dzrefFilesData'     => $thumbnailData,
            'dzPrefilledDataRef' => 'qibla_listing_form-thumbnail_exists_ids',
            'dictDefaultMessage' => esc_html_x('Drop your listing main image here', 'placeholder', 'qibla-directory'),
        ),
        'attrs'               => array(
            'required' => 'required',
        ),
