...
return apply_filters('qibla_listings_form_additional_info_fields', array(
    ...
    'qibla_listing_form-meta-open_hours:textarea'  => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Type the open hours', 'qibla-directory'),
        'invalid_description' => esc_html__('Please enter valid text. No html allowed.', 'qibla-directory'),
        'value'               => $fieldsValues['open_hours'],
        'attrs'               => array(
            'placeholder' => esc_html_x("Fri 10:00 am - 8:30pm\nSat - Thu 10:00 am - 5:30 pm", 'placeholder', 'qibla-directory'),
        ),
    )),
    ...
    'qibla_listing_form-meta-business_email:email' => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Your listing email', 'qibla-directory'),
        'invalid_description' => esc_html__('Please provide a valid email address.', 'qibla-directory'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') and $obj->getInvalidDescription();
        },
        'attrs'               => array(
            'placeholder' => esc_html_x('Es. joe.doe@gmail.com', 'placeholder', 'qibla-directory'),
    ...
    'qibla_listing_form-meta-business_phone:tel'   => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Your listing phone number', 'qibla-directory'),
        'invalid_description' => esc_html__('Please enter valid phone number.', 'qibla-directory'),
        'after_input'         => function ($obj) {
            return $obj->getType()->getArg('is_invalid') and $obj->getInvalidDescription();
        },
        'attrs'               => array(
            'placeholder' => esc_html_x('Es. 555-2033012', 'placeholder', 'qibla-directory'),
    ...
    'qibla_listing_form-meta-site_url:url'         => $fieldFactory->base(array(
        ...
        'label'               => esc_html__('Listing website URL', 'qibla-directory'),
        ...
        'attrs'               => array(
            'placeholder' => esc_html_x('https://www.my-awesome-site.com', 'placeholder', 'qibla-directory'),
