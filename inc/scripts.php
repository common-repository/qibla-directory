...
if (is_admin()) {
    ...
    $scripts['styles'] = array_merge($scripts['styles'], array(
        // Premium.
        'qibla-directory-premium'   => array(
            'qibla-directory-premium',
     ...
     */
    $scripts = apply_filters('qibla_directory_admin_scripts_list', $scripts);
} else {
    // Front Scripts.
    $scripts['scripts'] = array_merge($scripts['scripts'], array(
        /*
        ...
        'dlreview'                           => array(
            ...
            function () {
                return Context::isSingleListings() and
                       ('off' === F\getPluginOption('listings', 'disable_reviews', true));
            },
            array(
                'async' => 'async',
            ),
    ...
    if ('off' === F\getPluginOption('general', 'disable_css', true)) {
        $scripts['styles']['qibla-directory-main'] = array(
            'qibla-directory-main',
        ...
        $scripts['styles']['qibla-directory-base'] = array(
            'qibla-directory-base',
     ...
     * @param array $scripts The array of the scripts
     */
    $scripts = apply_filters('qibla_directory_front_scripts_list', $scripts);
}
