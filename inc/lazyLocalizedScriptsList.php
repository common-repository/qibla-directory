...
$context = new \QiblaDirectory\ListingsContext\Context(
    F\getWpQuery(),
    new \QiblaDirectory\ListingsContext\Types()
);
 ...
 */
return apply_filters('qibla_directory_lazy_localized_scripts_list', $list);
