...
use QiblaDirectory\Requirements;
use QiblaDirectory\Admin;
...
return apply_filters('qibla_filters_admin', array(
    'admin' => array(
        'action' => array(
            ...
            array(
                ...
                'callback' => array(
                    new Admin\Notice\NoticeList(
                        '<strong>' . esc_html__('Qibla Directory Warning', 'qibla-directory') . '</strong>',
                        $req->check(),
                        'error'
                    ),
                    'notice',
            ...
            array(
                'filter'   => 'admin_notices',
                'callback' => 'QiblaDirectory\\Notice\\NoticeUpdateMetaListings::noticeFilter',
                'priority' => 10,
            ),
            ...
            array(
                'filter'   => 'admin_init',
                'callback' => 'QiblaDirectory\\Admin\\PermalinkSettings::permalinkSettingsFilter',
            ...
            array(
                'filter'   => 'wp_loaded',
                'callback' => array(
                    'QiblaDirectory\\Admin\\Settings\\Controller',
            ...
            array(
                ...
                'callback' => function ($comment) {
                    $types = new \QiblaDirectory\ListingsContext\Types();
            ...
            array(
                ...
                'callback'      => 'QiblaDirectory\\Functions\\setParentTerm',
                'priority'      => 20,
                'accepted_args' => 6,
            ),
        ),
        'filter' => array(
            ...
            array(
                ...
                'callback' => 'QiblaDirectory\\Functions\\adminBodyClass',
                'priority' => 20,
            ),
        ),
    ),
