        ...
        DL.Autocomplete = {
            ...
            onSelect: function (suggestion)
            {
                if (typeof suggestion.data !== "undefined") {
                    ...
                    if (!form.querySelector('#qibla_listing_categories_filter')) {
                        input = document.createElement('input');
                        input.setAttribute('name', 'qibla_listing_categories_filter');
                        input.setAttribute('id', 'qibla_listing_categories_filter');
                        input.setAttribute('type', 'hidden');
            ...
            construct: function (field, data)
            {
                ...
                this.ajaxUrl = dllocalized.site_url + '/index.php';
