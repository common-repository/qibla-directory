    ...
    DL.Review = {
        ...
        ReplyForm: {
            ...
            setReplyLabels: function (form, container)
            {
                ...
                titleEl.innerHTML = localized.formLabels.replyTitle.replace(
                    '%s',
                ...
                commentFormCommentEl.innerText = localized.formLabels.textAreaLabel;

                var submitEl = form.querySelector('input[type="submit"]');
                submitEl.setAttribute('data-oldtext', submitEl.value);
                submitEl.value = localized.formLabels.submitLabel;
            },
