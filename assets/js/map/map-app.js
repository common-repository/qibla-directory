...
(function (_, Backbone, google, dlgooglemap, DlMap, DlListings, dllocalized)
{
    ...
    function getDefaultMapCenter()
    {
        ...
        if (!_.isUndefined(dlgooglemap.center.lat) && !_.isUndefined(dlgooglemap.center.lng)) {
            defaultCenter = new google.maps.LatLng(dlgooglemap.center.lat, dlgooglemap.center.lng);
        }
    ...
    document.addEventListener('DOMContentLoaded', function ()
    {
        ...
        DlMap.STYLE = (function (style)
        {
            try {
                ...
                if (!_.isEmpty(dlgooglemap.style)) {
                    style = _.union(style, JSON.parse(dlgooglemap.style));
                }
            } catch (e) {
...
}(_, Backbone, google, dlgooglemap, window.DlMap, window.DlListings, dllocalized));
