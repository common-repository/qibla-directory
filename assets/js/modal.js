...
;(
    function (_, $, ClassList, DL, dllocalized, dlLocalizedModal)
    {
        "use strict";
        ...
        DL.Modal = {
            ...
            addCloseBtn: function ()
            {
                ...
                text.innerText = dlLocalizedModal.closeBtn;
        ...
        DL.Modal.LoginRegisterForm = {
            ...
            createTogglers: function ()
            {
                ...
                signupLink.innerHTML = dlLocalizedModal.signupLabel;

                // Sign Up Form.
                if (typeof this.forms[1] !== 'undefined' && 0 < parseInt(dllocalized.usersCanRegister)) {
                    // Sign In Toggler
                    ...
                    signinLink.innerHTML = dlLocalizedModal.signinLabel;
                ...
                // Lost Password Form.
                if (typeof this.forms[2] !== 'undefined' && 0 < parseInt(dllocalized.usersCanRegister)) {
                    // Lost Password
                    DL.Utils.Functions.classList(lostpasswordLink).add(
                        'dllogin-register-form__lostpassword-link',
                        'dlmodal-form-toggler'
                    );
                    lostpasswordLink.innerHTML = dlLocalizedModal.lostPasswordLabel;
                    // Get Back
                    DL.Utils.Functions.classList(goBack).add(
                        'dllogin-register-form__go-back',
                        'dlmodal-form-toggler'
                    );
                    goBack.innerText = dlLocalizedModal.goBackLabel;
                    ...
                    var lostPasswordTarget = this.loginRegisterForm.querySelector('#qibla_directory_login_form-remember');
