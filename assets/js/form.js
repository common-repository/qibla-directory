                ...
                var FormHandler = {
                    ...
                    errorResponseHandler: function (error)
                    {
                        try {
                            ...
                            this.showAlert(dlformlocalized.unknownError, 'error', ['la', 'la-times'], true);
                        }
                    ...
                    validateDropzoneFiles: function ()
                    {
                        ...
                        for (var c = 0; c < this.dropZone.dropzoneCollection.length; ++c) {
                            ...
                            if (currentFile.getRejectedFiles().length) {
                                this.showAlert(dlformlocalized.rejectedFiles, 'error', ['la', 'la-times'], true);
                                ...
                                this.showAlert(dlformlocalized.missedFile, 'error', ['la', 'la-times'], true);
                    ...
                    submit: function (evt)
                    {
                        ...
                        $.ajax(dllocalized.site_url + '/index.php', _.extend({
                            method: 'post',
                            data: data
                        }, {
