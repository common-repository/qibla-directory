...
if ( ! class_exists( 'TGM_Plugin_Activation' ) ) {
	...
	class TGM_Plugin_Activation {
		...
		public function register( $plugin ) {
			...
			$plugin['source_type']        = empty( $plugin['source_type'] ) ? 'repo' : $plugin['source_type'];
			...
			$plugin['source_type'] = $this->get_plugin_source_type( $plugin['source_type'] );
