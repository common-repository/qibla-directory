...
<section <?php F\scopeClass('nocontent-found-listings') ?>>
    <h1 <?php F\scopeClass('nocontent-found-listings', 'title') ?>>
        <?php esc_html_e('Sorry, no posts matched your criteria.', 'qibla-directory'); ?>
    </h1>

    <?php echo do_shortcode(
        '[dl_button label="' .
        esc_html__('Restart the search', 'qibla-directory') . '" url="' .
        esc_url(get_post_type_archive_link('listings')) .
