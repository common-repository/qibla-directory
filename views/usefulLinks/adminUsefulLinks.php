...
<div class="wrap">
    ...
    <div id="useful-link-container">
        ...
        <div class="stuffbox doc-box">
            <div class="header">
                <div class="inside">
                    <h2 class="ul-title"><?php esc_html_e('Shop Themes and Plugins', 'qibla-directory'); ?></h2>
                    <a href="<?php echo esc_url($data->shop_url); ?>"
                       class="button button-primary ul-button" target="_blank">
                        <?php esc_html_e('Shop', 'qibla-directory'); ?>
                    </a>
                </div>
            </div>
            <div class="inside text">
        ...
        <div class="stuffbox doc-box">
            <div class="header">
                <div class="inside">
                    <h2 class="ul-title"><?php esc_html_e('Qibla2app', 'qibla-directory'); ?></h2>
                    <a href="<?php echo esc_url($data->qibla2app_url); ?>" target="_blank"
                       class="button button-primary ul-button">
                        <?php esc_html_e('More', 'qibla-directory'); ?>
                    </a>
                </div>
            </div>
            <div class="inside">
