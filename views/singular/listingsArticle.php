 ...
 * @since 1.0.0
 */
do_action('qibla_directory_before_single_listings_loop'); ?>

<article id="post-<?php the_ID() ?>" <?php post_class(F\getScopeClass('article', '', 'listings')) ?>>
    <?php
    /**
     ...
     * @since 1.0.0
     */
    do_action('qibla_directory_before_single_listings_header'); ?>
    ...
    <?php if ('yes' === apply_filters('qibla_show_single_listings_header', 'yes')) : ?>
        ...
        <header <?php F\scopeClass('article', 'header') ?>>
             ...
             * @since 1.0.0
             */
            do_action('qibla_directory_single_listings_header'); ?>
     ...
     * @since 1.0.0
     */
    do_action('qibla_directory_before_single_listing_loop_entry_content'); ?>
     ...
     * @since 1.0.0
     */
    do_action('qibla_directory_after_single_listings_loop_entry_content'); ?>
</article>
 ...
 * @since 1.0.0
 */
do_action('qibla_directory_after_single_listings_loop'); ?>
