...
if (! post_password_required()) : ?>
    <div <?php F\scopeID('content') ?> <?php F\scopeClass('wrapper') ?>>
         ...
         * @since 1.0.0
         */
        do_action('qibla_directory_single_listings_content'); ?>
        ...
        <div <?php F\scopeClass('container', '', 'flex') ?>>
             ...
             * @since 1.0.0
             */
            do_action('qibla_directory_before_single_listings'); ?>
            ...
            $sidebar = 'qibla-sidebar-listings'; ?>
                <div <?php F\scopeID('sidebar-listings') ?> <?php F\sidebarClass('sidebar', '', 'listings') ?>>
                     ...
                     * @since 1.0.0
                     */
                    do_action('qibla_directory_listings_sidebar');
                    ...
                    if (is_active_sidebar($sidebar)) :
                         ...
                         */
                        do_action('qibla_directory_listings_sidebar_content', $sidebar);
                    endif; ?>
                </div>
             ...
             * @since 1.0.0
             */
            do_action('qibla_directory_after_single_listings'); ?>
         ...
         * @since 1.0.0
         */
        do_action('qibla_directory_after_single_listings_content'); ?>
