...
<div <?php F\scopeID('content') ?> <?php F\scopeClass('wrapper') ?>>
     ...
     * @since 1.0.0
     */
    do_action('qibla_directory_before_archive_listings_content'); ?>
    ...
    <div <?php F\scopeClass('container', '', 'flex') ?>>
         ...
         * @since 1.0.0
         */
        do_action('qibla_directory_before_archive_listings'); ?>
        ...
        <main <?php F\scopeID('main') ?> <?php F\scopeClass() ?>>
             ...
             * @since 1.0.0
             */
            do_action('qibla_directory_before_archive_listings_list'); ?>
            ...
            <div <?php F\scopeClass('listings-list') ?>>
                ...
                if (have_posts()) :
                     ...
                     * @since 1.0.0
                     */
                    do_action('qibla_directory_before_archive_listings_loop'); ?>

                    <div <?php F\scopeClass('grid') ?>>
                        <?php
                        while (have_posts()) :
                            the_post();
                            load_template(Plugin::getPluginDirPath('/views/loop/listings.php'), false);
                        endwhile;
                        ?>
                    </div>
                     ...
                     * @since 1.0.0
                     */
                    do_action('qibla_directory_after_archive_listings_loop');
                else :
             ...
             * @since 1.0.0
             */
            do_action('qibla_directory_after_archive_listings_list'); ?>
         ...
         * @since 1.0.0
         */
        do_action('qibla_directory_after_archive_listings'); ?>
     ...
     * @since 1.0.0
     */
    do_action('qibla_directory_after_archive_listings_content'); ?>
