...
namespace QiblaDirectory\Search\Field;
...
use QiblaDirectory\Utils\Json\Encoder;
...
final class Search implements SearchFieldInterface, TemplateInterface
{
    ...
    private function jsonEncoderFactory()
    {
         ...
         * @since ${SINCE}
         */
        $args = apply_filters('qibla_directory_search_json_encoder_factory', array(
            'type'             => 'listings',
            'containers'       => array(
                'taxonomies' => 'listing_categories',
            ),
            'initialContainer' => 'listing_categories'
        ));
