...
namespace QiblaDirectory\Search;

use QiblaDirectory\Form\Factories\FieldFactory;
use QiblaDirectory\Search\Field\Geocoded as GeocodedField;
use QiblaDirectory\Search\Field\Search as SearchField;
use QiblaDirectory\Search\Field\Taxonomy;

/**
 * Class SearchBySettings
 *
 * @since   1.0.0
 * @package QiblaDirectory\Search
 * @author     Guido Scialfa <dev@guidoscialfa.com>
 */
class SearchFactory
{
