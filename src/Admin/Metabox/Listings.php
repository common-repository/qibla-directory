<?php
namespace QiblaDirectory\Admin\Metabox;

use QiblaDirectory\Form\Fieldsets\BaseFieldset;
 ...
 *
 * @since      1.0.0
 * @package    QiblaDirectory\Admin\Metabox
...
class Listings extends AbstractMetaboxFieldset
{
    ...
    public function __construct(array $args = array())
    {
        ...
        parent::__construct(wp_parse_args(array(
            'id'       => 'listing_option',
            'title'    => esc_html__('Listing Option', 'qibla-directory'),
        ...
        parent::setFieldsets(array(
            ...
            new BaseFieldset(include Plugin::getPluginDirPath('/inc/metaboxFields/listingsLocationsFields.php'), array(
                ...
                'id'              => 'listing_map',
                'name'            => 'map',
                'legend'          => esc_html__('Location', 'qibla-directory'),
            ...
            new BaseFieldset(
                ...
                array(
                    ...
                    'legend'          => esc_html__('Additional Info', 'qibla-directory'),
                    'container_class' => array('dl-metabox-fieldset'),
            ...
            new BaseFieldset(include Plugin::getPluginDirPath('/inc/metaboxFields/socialsUrlsFields.php'), array(
                ...
                'id'              => 'listing_socials',
                'name'            => 'socials',
                'legend'          => esc_html__('Socials', 'qibla-directory'),
                'container_class' => array('dl-metabox-fieldset'),
            ...
            new BaseFieldset(include Plugin::getPluginDirPath('/inc/metaboxFields/galleryFields.php'), array(
                ...
                'id'              => 'listing_gallery',
                'name'            => 'gallery',
                'legend'          => esc_html__('Gallery', 'qibla-directory'),
                'container_class' => array('dl-metabox-fieldset'),
            ...
            new BaseFieldset(include Plugin::getPluginDirPath('/inc/metaboxFields/relatedPostsFields.php'), array(
                ...
                'id'              => 'related_posts',
                'name'            => 'related_posts',
                'legend'          => esc_html__('Related Posts', 'qibla-directory'),
                'container_class' => array('dl-metabox-fieldset'),
