...
namespace QiblaDirectory\Admin;
...
class PermalinkSettings
{
    ...
    public function __construct()
    {
        static::$sectionArgs = array(
            static::SECTION_NAME,
            esc_html__('Qibla Post Type &amp; Taxonomies Permalinks', 'qibla-directory'),
    ...
    public function store()
    {
        ...
        foreach (static::$fieldArgs as $key => $args) {
            ...
            // @codingStandardsIgnoreLine
            $value = \QiblaDirectory\Functions\filterInput($_POST, $key, FILTER_SANITIZE_STRING);
    ...
    public static function permalinkSettingsFilter()
    {
        ...
        remove_action('admin_init', 'QiblaDirectory\\Admin\\PermalinkSettings::permalinkSettingsFilter', 0);
    }
}
