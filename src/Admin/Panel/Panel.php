 ...
 *
 * @since      1.0.0
 * @package    QiblaDirectory\Admin\Panel
...
namespace QiblaDirectory\Admin\Panel;
...
class Panel
{
    ...
    protected function footer()
    {
        ...
        <footer class="dm-panel__footer">
            <?php echo sprintf(
                '<p>%s <a href="%s">&#9733;&#9733;&#9733;&#9733;&#9733;</a> %s</p>',
                esc_html__('If you like Qibla Directory Plugin please leave us a rating. ', 'qibla-directory'),
                esc_url('https://wordpress.org/support/plugin/qibla-directory/reviews/'),
                esc_html__('A huge thank you in advance!', 'qibla-directory')
            ); ?>
        </footer>
        <?php
    }
