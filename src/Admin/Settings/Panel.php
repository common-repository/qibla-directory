...
use QiblaDirectory\Admin\Panel\Navigation;
use QiblaDirectory\Admin\Panel\Panel as BasePanel;
        ...
        <div class="dm-panel__sidebar">
            <header class="dm-panel__header">
                ...
                <span class="dm-panel__theme-version">
                    <?php printf(
                        esc_html__('Version: %s', 'qibla-directory'),
                ...
                <span class="dm-panel__credits">
                    <?php echo sprintf(
                        ...
                        esc_html__('App&Map', 'qibla-directory')
                    ); ?>
                </span>
            </header>
