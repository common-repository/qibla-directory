...
namespace QiblaDirectory\Admin\Settings;

use QiblaDirectory\Functions as F;
use QiblaDirectory\Admin\Panel\Navigation as AdminNavigation;
use QiblaDirectory\Admin\Settings\Panel as AdminSettingsPanel;
use QiblaDirectory\Admin\Notice\Notice;
use QiblaDirectory\Form\Validate;
 ...
 *
 * @since      1.0.0
 * @package    QiblaDirectory\Admin\Settings
...
class Controller
{
     ...
     */
    private $namespace = 'QiblaDirectory\\Admin\\Settings';
                ...
                case 'import-export':
                    ...
                    elseif (F\filterInput($_POST, 'qibla_opt_reset', FILTER_SANITIZE_STRING)) :
                        try {
                            ...
                            $importedMsg = esc_html__('Options have been reset correctly.', 'qibla-directory');
                        } catch (\Exception $e) {
    ...
    public static function initializeControllerFilterCallback()
    {
        ...
        if (in_array($allowedPage, array('qibla-directory-options'), true)) :
            ...
            $controllerPanel->setPanel(new AdminSettingsPanel(
                new AdminNavigation(
                    admin_url('admin.php?page=qibla-directory-options'),
                    $settingsMenuList,
            ...
            add_action('qibla_directory_admin_settings_page_content', array($controllerPanel, 'render'));
