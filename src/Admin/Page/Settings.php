 ...
 *
 * @since      1.0.0
 * @package    QiblaDirectory\Admin\Page
...
class Settings extends AbstractMenuPage
{
    ...
    {
        parent::__construct(
            esc_html_x('Qibla Directory', 'admin-menu', 'qibla-directory'),
            esc_html_x('Qibla Directory', 'admin-menu', 'qibla-directory'),
            'qibla-directory-options',
    ...
    public function callback()
    {
        ...
        $data->title = esc_html__('Plugin Options', 'qibla-directory');
