<?php
namespace QiblaDirectory\Front\Settings;
...
class Listings
{
    ...
    public static function showMapOnArchive()
    {
        ...
        $option = F\getPluginOption('listings', 'archive_show_map', true);
    ...
    public static function postsPerPage($query)
    {
        ...
        $setting = F\getPluginOption('listings', 'posts_per_page', true);
    ...
    public static function orderByFeatured($posts, \WP_Query $query)
    {
        ...
        $setting = F\getPluginOption('listings', 'order_by_featured', true);
        if ('on' !== $setting) {
            return $posts;
        }
    ...
    public static function forceDisableReviews($disable)
    {
        ...
        // Retrieve the option.
        $option = F\getPluginOption('listings', 'disable_reviews', true);
        // 'on' => 'yes', off => 'no'
