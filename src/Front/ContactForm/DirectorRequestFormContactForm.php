...
use QiblaDirectory\Form\MockFieldsByAjaxRequest;
use QiblaDirectory\Request\AbstractDirectorRequestForm;
    ...
    public function director()
    {
        ...
        if (! empty($validationResponse['invalid'])) {
            $response = new Response(
                400,
                esc_html__('Ops! Some content is not valid. Please check it.', 'qibla-directory')
            );
