...
namespace QiblaDirectory\Front\ContactForm;

use QiblaDirectory\Request\AbstractRequestFormController;
...
class RequestFormContactFormController extends AbstractRequestFormController
{
    ...
    public function handle()
    {
        ...
        return $response ? new Response(
            200,
            esc_html__('Thank you the email has been send successfully.', 'qibla-directory')
        ) : new Response(
            500,
            esc_html__('Ops! An error occurred. Try in a few minutes.', 'qibla-directory')
        );
    }
}
