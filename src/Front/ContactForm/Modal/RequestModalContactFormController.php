...
use QiblaDirectory\Modal\ModalTemplate;
use QiblaDirectory\Request\AbstractRequestController;
use QiblaDirectory\Request\Response;
...
class RequestModalContactFormController extends AbstractRequestController
{
    ...
    public function handle()
    {
        ...
        $modal = new ModalTemplate(function () use ($self) {
            ...
            'context'         => 'script',
            'title'           => esc_html__('Contact the owner', 'qibla-directory'),
            'subtitle'        => esc_html__('We\'ll reply you as soon as possible', 'qibla-directory'),
        ));
