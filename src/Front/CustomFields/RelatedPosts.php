...
class RelatedPosts extends AbstractMeta implements TemplateInterface
{
    ...
    public function getData()
    {
        ...
        $taxName = 'post' === get_post_type() ? 'category' : 'listing_categories';
        ...
        if (Context::isSingleListings()) {
            ...
            $cta['label'] = F\getPluginOption('listings', 'related_post_cta_label', true);
    ...
    public function tmpl(\stdClass $data)
    {
        ...
        $shortcodeClass     = 'QiblaDirectory\\Shortcode\\' . ucfirst(get_post_type());
        ...
        $this->loadTemplate('qibla_mb_show_related', $data, '/views/relatedPosts.php');
    }
