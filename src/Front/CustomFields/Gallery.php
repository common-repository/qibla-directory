...
class Gallery extends AbstractMeta
{
    ...
    private function getBackgroundImage()
    {
        ...
        $backgroundSrc   = wp_get_attachment_image_src($backgroundId, 'qibla-directory-gallery');

        $data = array(
            'background_color' => $backgroundColor,
            'background_id'    => $backgroundId,
            'background_size'  => 'qibla-directory-gallery',
         ...
         */
        $data = apply_filters(
            'qibla_directory_fw_jumbotron_background',
            $data,
            $backgroundColor,
            $backgroundId,
            $backgroundSrc,
    ...
    public function template()
    {
        ...
        if (Context::isSingleListings()) {
            ...
            $data->dataLabel = esc_html__('See gallery', 'qibla-directory') . ':';
    ...
    public function customCss()
    {
         ...
         */
        $data = apply_filters('qibla_directory_fw_jumbotron_data_style', $data, $this);
