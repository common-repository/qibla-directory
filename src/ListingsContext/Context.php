...
namespace QiblaDirectory\ListingsContext;
...
class Context
{
     ...
     * @since 1.0.0
     *
     * @var \QiblaDirectory\ListingsContext\Types The listings custom post types
     */
    private $types;
     ...
     * @param \QiblaDirectory\ListingsContext\Types $types The listings custom post types.
     */
