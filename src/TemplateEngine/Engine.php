<?php
namespace QiblaDirectory\TemplateEngine;
 ...
 *
 * @since      1.0.0
 * @package    QiblaDirectory\TemplateEngine
...
class Engine
{
    ...
    public function render()
    {
         ...
         * @param string    $name The name of the current template instance.
         */
        $data = apply_filters('qibla_directory_template_engine_data', $this->data, $this->name);
         ...
         * @param \stdClass $data The template data.
         */
        $data = apply_filters("qibla_directory_template_engine_data_{$this->name}", $data);
         ...
         * @param \stdClass                             $data         The template data.
         * @param \QiblaDirectory\TemplateEngine\Engine $this         The instance of the class.
         */
        $viewPath = apply_filters('qibla_directory_template_path', $viewPath, $data, $this);
