<?php
namespace QiblaDirectory\Form\Handlers;

use QiblaDirectory\Exceptions\FileNotExistsException;
use QiblaDirectory\Form\MimeType;
use QiblaDirectory\Plugin;
use QiblaDirectory\Form\Exceptions\ExceptionUpload;

/**
 * File Handler
 *
 * @since      1.0.0
 * @package    QiblaDirectory\Form\Fields
