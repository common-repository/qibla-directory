...
use QiblaDirectory\Form\Abstracts\MediaType;
...
class MediaImage extends MediaType
{
    ...
    public function __construct($args)
    {
        $args = wp_parse_args($args, array(
            'btn' => array(
                'label'            => esc_html__('Add Image', 'qibla-directory'),
                'data_media_title' => esc_html__('Upload Image', 'qibla-directory'),
            ),
        ));
    ...
    public function getHtml()
    {
         ...
         */
        $output = apply_filters('qibla_directory_type_mediaimage_output', $output, $this);
