...
use QiblaDirectory\Form\Abstracts\Type;
...
class Select extends Type
{
    ...
    protected function buildOptions(array $options)
    {
         ...
         * @param \QiblaDirectory\Form\Types\Select $this    The class instance
         */
        $options = apply_filters('qibla_directory_forms_type_select_options_before_build', $options, $this);
    ...
    public function __construct($args)
    {
        ...
        if (! isset($args['options']['none']) && empty($args['exclude_none'])) {
            $args['options'] = array_merge(
                array('none' => esc_html__('Select an option', 'qibla-directory')),
                $args['options']
            );
        }
    ...
    public function getHtml()
    {
         ...
         */
        $output = apply_filters('qibla_directory_type_select_output', $output, $this);
