...
abstract class MediaType extends Type
{
    ...
    public function __construct($args)
    {
        ...
        $args['btn'] = array_merge(array(
            'label'            => esc_html__('Add Media', 'qibla-directory'),
            'data_media_title' => esc_html__('Upload Media', 'qibla-directory'),
            'data_multiple'    => 'no',
        ), $args['btn']);
    ...
    public function getHtml()
    {
        ...
        if (null === $media) {
            $btn .= '<p>' . esc_html__('Error Media not found.', 'qibla-directory') . '</p>';
        }
