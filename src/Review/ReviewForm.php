...
class ReviewForm
{
    ...
    private static $notFieldsAllowedIfAuthor = array(
        'QiblaDirectory\Review\RatingField',
        'QiblaDirectory\Review\ReviewTitleField',
    );
    ...
    public function __construct(\WP_Post $post, array $fields)
    {
        ...
        $this->fields = $fields;
        $this->args   = array(
            'title_reply'          => esc_html__('Write a Review', 'qibla-directory'),
            'label_submit'         => esc_html__('Submit review', 'qibla-directory'),
            'comment_field'        => '<p class="comment-form-comment"><label for="comment">' .
                                      esc_html__('Your Review', 'qibla-directory') .
