...
class ReviewList
{
                ...
                if ($title) {
                    $data->commentTitle = sprintf(
                        ...
                        /* Translators: the %2$s is the title of the post. The %1$s is number of the reviews. */
                            _n('One review to %2$s', '%1$s reviews to %2$s', $cnumber, 'qibla-directory')),
                        $cnumber,
                    ...
                    $data->commentTitle = sprintf(
                        ...
                        /* Translators: the %1$s is number of the reviews. */
                            _n('One review', '%1$s reviews', $cnumber, 'qibla-directory')),
                        $cnumber
                    );
                }
            endif;
    ...
    public static function reviewListFilter()
    {
         ...
         */
        $disable = apply_filters('qibla_directory_disable_reviews', 'no');
