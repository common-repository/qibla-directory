...
namespace QiblaDirectory\Review;
...
class Rating
{
    ...
    public function getRatingData()
    {
        ...
        return (object)array(
            'label' => isset($ratingList[$this->value]) ?
                ...
                esc_html__('Unknown', 'qibla-directory'),
    ...
    {
        return array(
            '1' => esc_html__('Very Poor', 'qibla-directory'),
            '2' => esc_html__('Not Bad', 'qibla-directory'),
            '3' => esc_html__('Average', 'qibla-directory'),
            '4' => esc_html__('Good', 'qibla-directory'),
            '5' => esc_html__('Perfect', 'qibla-directory'),
        );
    }
