...
namespace QiblaDirectory\Listing\Expire;
...
class EmailOnExpiration
{
     ...
     * @since  1.0.0
     *
     * @uses   QiblaDirectory\Functions\getPluginOption() to retrieve the placeholder message.
     *
    ...
    protected function buildMessage()
    {
        ...
        ), F\getPluginOption('listings', 'expired_listing_email'));
    ...
    public function __construct(\WP_User $recipient, \WP_Post $post)
    {
        ...
        /* Translators: %s is the post title */
            esc_html_x('Listing %s Expired', 'expired_email', 'qibla-directory'),
            $this->sanitizeString($this->post->post_title)
        );
     ...
     * @uses   QiblaDirectory\Functions\ksesPost() to sanitize the message content
     *
