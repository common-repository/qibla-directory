...
namespace QiblaDirectory\Listing\ManagerPosts;

use QiblaDirectory\Functions as F;
use QiblaDirectory\Listing\UserListingsPosts;
use QiblaDirectory\EndPoint\AbstractEndPoint;
...
class MyListingsEndPoint extends AbstractEndPoint
{
    ...
    public function __construct()
    {
        parent::__construct(array(
            'slug'        => $this->slug(),
            'label'       => esc_html_x('My Listings', 'endpoint', 'qibla-directory'),
    ...
    public function getEndPointLabel()
    {
        ...
        return esc_html_x($this->endPointData['label'], 'endpoint', 'qibla-directory');
    }
    ...
    public function editSlug($settings)
    {
        ...
        foreach ((array)$settings as $section) {
            if (isset($section['id']) && 'woocommerce_myaccount_edit_account_endpoint' === $section['id']) {
                ...
                $newSettings[] = array(
                    'title'    => esc_html_x('My Listings', 'my-account', 'qibla-directory'),
                    'desc'     => esc_html_x(
