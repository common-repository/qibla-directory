...
use QiblaDirectory\Package\Package;
    ...
    public function __construct(Types $types, \WP_Post $packagePost, \WP_Post $post)
    {
        ...
        $this->actions     = array(
            ...
            'edit'   => (object)array(
                ...
                'icon'  => 'la la-edit',
                'label' => esc_html_x('Edit', 'account-posts-manager', 'qibla-directory'),
            ),
            // Delete Action.
            'delete' => (object)array(
                ...
                'icon'  => 'la la-trash',
                'label' => esc_html_x('Delete', 'account-posts-manager', 'qibla-directory'),
            ),
        );
    }
