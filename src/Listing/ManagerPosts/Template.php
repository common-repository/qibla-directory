...
use QiblaDirectory\Utils\TimeZone;
use QiblaDirectory\Listing\Expire\ExpirationByDate;
    ...
    public function getData()
    {
        ...
        foreach ($this->posts as $post) :
            ...
            $newPost->expirationDate = (
                ...
                esc_html__('Never', 'qibla-directory') :
            ...
            $newPost->status = (ListingsPost::EXPIRED_STATUS === $post->post_status) ?
                esc_html_x('Qibla Expired', 'manager-posts', 'qibla-directory') :
                $post->post_status;
