...
namespace QiblaDirectory\Listings;
 ...
 * @author     Guido Scialfa <dev@guidoscialfa.com>
 */
class ListingsPost implements ListingsPostInterface, LocalizableInterface, ThumbnailLiableInstance, IconizeInterface, ListingTermInterface, SubTitleInterface
{
    /**
     * WP Post
     *
    ...
    {
        $iconCompact = $default;
        // Retrieve the first term of listing_categories taxonomy.
        // Icons for listings are grub down by the first term.
        $terms = get_the_terms($this->ID(), 'listing_categories');
