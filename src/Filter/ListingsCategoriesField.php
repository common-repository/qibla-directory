...
class ListingsCategoriesField implements FilterFieldInterface
{
     ...
     * @since 1.0.0
     *
     * @var \QiblaDirectory\Form\Interfaces\Fields A field instance
     */
    private $field;
    ...
    private function value()
    {
        ...
        if (! $value) {
            ...
            $value = $qObj instanceof \WP_Term && is_tax('listing_categories') ? $qObj->slug : 'all';
        }
    ...
    public function __construct($name, $type)
    {
        ...
        $allOptionsLabel = apply_filters(
            ...
            esc_html__('All Categories', 'qibla-directory')
        );
