...
use QiblaDirectory\Collection;
use QiblaDirectory\Form\Types\Hidden;
use QiblaDirectory\Functions as F;
use QiblaDirectory\Form\Abstracts;
...
class Form extends Abstracts\Form
{
     ...
     * @since 1.0.0
     *
     * @var \QiblaDirectory\Collection A collection of filters
     */
    private $filters;
     ...
     *
     * @var \QiblaDirectory\Listings\Context The context in which the form works
     */
    private $context;
     ...
     * @since 1.0.0
     *
     * @var \QiblaDirectory\Filter\GeocodeFilter The geocode filter instance
     */
    ...
    public function getHtml()
    {
         ...
         * @param \QiblaDirectory\Filter\Form $this    The instance of this form.
